...
export default function AddedList() {
  ...
  return (
    <div className="sm:w-[420px] w-[95dvw] flex h-8 bg-[#eef2f8] items-center justify-between">
        <p className="pl-2 text-slate-700 whitespace-nowrap overflow-hidden text-ellipsis">{validWords.join(', ')}
        </p>
